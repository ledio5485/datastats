...
2. 𝑥: A real number with a fractional part of up to 10 digits, always in 0..1.
3. 𝑦: An integer in 1,073,741,823..2,147,483,647.
...
2. Use [Kotlin/JVM](https://kotlinlang.org/) or Java
3. Use [Gradle](https://gradle.org/) or [Maven](https://maven.apache.org/)
4. API must be thread safe
5. API must accept concurrent requests
6. Project and tests must be buildable and executable
7. No databases (MySQL, Postgres, H2, HyperSQL, …)
8. No cleanup threads in any form
...
3. Code is readable and comprehensible. Setup instructions and run instructions
   are provided.
4. Tests are show cased (no need to cover everything).
